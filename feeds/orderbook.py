...
class OrderBook:
    ...
    def snapshot(self, pct=0.5, max_levels=1200):
        ...
        уровней никогда не попадёт на экран. Фильтр ±0.5% режет ~4000 уровней
        до ~700 — в 5.6 раза меньше трафика без потери видимой картины.
