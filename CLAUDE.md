...
- **Серия убытков НЕ обнуляется на границе суток** и не разрывается refund:
  вчерашние dry-убытки попали в сегодняшнюю серию и остановили demo-прогон
  по max_consecutive_losses=3. Нужно решение владельца о семантике
  (только сегодняшние сделки? разрывать ли refund?) — см. LOG 2026-08-06.
